    ...
    <div className="relative flex min-h-[80vh] w-full items-center justify-center overflow-hidden rounded-3xl px-4 py-12">
      <div className="relative z-10 flex flex-col items-center justify-center text-center">
        ...
        <div className="flex w-full max-w-[280px] flex-col gap-3 sm:max-w-none sm:flex-row sm:gap-4">
          ...
          <button
            onClick={reset}
            className="flex items-center justify-center gap-2 rounded-lg border-t border-slate-300/50 bg-gradient-to-b from-slate-700 to-slate-800 px-8 py-3.5 font-bold text-white shadow-lg transition-all hover:from-slate-400 hover:to-slate-700 active:scale-95"
          >
